...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
         ...
         * });
         */
        PrismaService_1.prototype.withTransaction = function (fn, options) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, _b;
                return __generator(this, function (_c) {
                    return [2 /*return*/, this.$transaction(fn, {
                            timeout: (_a = options === null || options === void 0 ? void 0 : options.timeout) !== null && _a !== void 0 ? _a : 10000, // 10s default
                            maxWait: (_b = options === null || options === void 0 ? void 0 : options.maxWait) !== null && _b !== void 0 ? _b : 5000,
                        })];
                });
            });
        };
