...
var AuditService = function () {
    ...
    var AuditService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.prisma.auditLog.create({
                                    data: {
                                        ...
                                        oldState: (_a = dto.oldState) !== null && _a !== void 0 ? _a : client_1.Prisma.JsonNull,
                                        newState: (_b = dto.newState) !== null && _b !== void 0 ? _b : client_1.Prisma.JsonNull,
                        ...
                        case 2:
                            ...
                            this.logger.error("Failed to write audit log: ".concat(err_1.message), { dto: dto });
                            return [2 /*return*/, {}];
        ...
        AuditService_1.prototype.findByResource = function (resourceType_1, resourceId_1) {
            return __awaiter(this, arguments, void 0, function (resourceType, resourceId, limit) {
        ...
        AuditService_1.prototype.findByTransaction = function (transactionId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.auditLog.findMany({
