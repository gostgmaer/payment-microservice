...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, port, env, apiPrefix, expressApp, swaggerConfig, document_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // ── Start server ────────────────────────────────────────────────────────
                    _a.sent();
                    app.get(nestjs_pino_1.Logger).log("\uD83D\uDE80 Payment Microservice running on port ".concat(port, " [").concat(env, "]"), 'Bootstrap');
                    // ── Graceful shutdown ───────────────────────────────────────────────────
                    ...
                    process.on('SIGTERM', function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    app.get(nestjs_pino_1.Logger).log('SIGTERM received — shutting down gracefully', 'Bootstrap');
                    ...
                    process.on('SIGINT', function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    app.get(nestjs_pino_1.Logger).log('SIGINT received — shutting down gracefully', 'Bootstrap');
                                    return [4 /*yield*/, app.close()];
                                case 1:
                                    _a.sent();
                                    process.exit(0);
